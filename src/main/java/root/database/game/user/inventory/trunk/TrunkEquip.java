...
public class TrunkEquip extends DBSnapshotList<TrunkEquip> {
    ...
    public LinkedList<TrunkEquip> lTrunkEquip;

    public TrunkEquip(Object dwAccountID, boolean bAutoLoad) {
        super(dwAccountID, bAutoLoad);
        this.lTrunkEquip = GetLoadedList();
    }
